...
In order to do this we need to look at the exact data we want to manipulate and calculate for.

```{r}
gazella_calc <- S3 |>
  group_by(PERIOD) |>
  summarize(gazella_prop = mean("X.Gazella")) |>
...
<img src="img/Munro et al Figure.png" width="200px" />
